package com.essential.indodriving.tools;
...
/**
 * Created by dongc_000 on 2/25/2016.
 */
public class AnimatorHelper {

    private static Animator zoomInAnimator;

    public static void zoomImageFromThumb(final View thumbView, Bitmap image, View rootView, final int shortAnimationDuration) {
